        ...
        <aside class="sidebar">
          ...
          <div class="sidebar__menu">
            <div class="sidebar__menu-brand">
              <a onClick={MovetoDashboard} class="sidebar__menu-logo">
            ...
            <nav class="sidebar__menu-nav">
              <ul class="sidebar__menu-list">
                <li class="sidebar__menu-item">
                  <a onClick={MovetoDashboard} class="sidebar__menu-link ">
                ...
                <li class="sidebar__menu-item">
                  <a onClick={Movetosettings} class="sidebar__menu-link active">
                    <span class="sidebar__menu-icon">
                      <svg
                        width="20"
                        height="19"
                ...
                <li class="sidebar__menu-item">
                  <button id="dark-light-mode" onClick={AppScript}>
                    Dark mode
                  </button>
                </li>
              </ul>
      ...
      <nav class="mobile-menu">
        <ul class="mobile-menu__list">
          <li class="mobile-menu__list-item">
            <a onClick={MovetoDashboard} class="mobile-menu__list-link active">
              <span class="icon">
                <svg
                  width="20"
                  height="21"
